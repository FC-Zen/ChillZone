...
import { Button, PageHeader, PickupSlot, PickupSlotProps } from '@components/molecules';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.commonColumn}>
                ...
                <View style={[styles.commonColumn, styles.restaurant]}>
                    <Text style={[styles.title, { textAlign: 'center' }]}>{restaurantText}</Text>
            ...
            <Button title={payButtonTitle} onPress={onPayBtnPress} style={styles.payBtn} />
        </View>
    );
}